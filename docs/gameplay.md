...
Kurzfassung der Spielregeln. Im Spiel selbst: Title-Screen → **HOW TO PLAY**.

## Tasks
- Item-Tasks: Objekt am Pult suchen, mit **E** mitnehmen.
- Laptop-Tasks: Setzen, Mini-App lösen — Casino (Glück), Teams oder Moodle (Logik).
- Co-op-Tasks: zwei Spieler müssen gleichzeitig am selben Spot stehen.
...
## Items
Vollständige Liste: [items.md](items.md).
...
| **Shift** | Sprint |
| **Space** | Springen |
| **E** | Interagieren / Aufheben / Wiederbeleben / Schrank |
| **Q** | Trank trinken |
| **F** | Wärmebild-Brille |
| **Linksklick** | Stuhl werfen |
| **G** | Stuhl ablegen |
...
- In Schränken kann man sich verstecken (**E**) — ausser ein Lehrer schaut gerade zu.
