...
const SECTIONS: Section[] = [
  ...
  },
  {
    title: "Tasks",
    bullets: [
      "Die offenen Aufgaben siehst du oben links in der HUD.",
      "Item-Tasks: Findet das gesuchte Objekt an einem Pult und nehmt es mit (E).",
      "Laptop-Tasks: Setzt euch an einen Laptop und löst die Mini-App: Casino-Spiel, Teams-Aufgabe oder Moodle-Suche.",
      "Sobald ALLE Aufgaben erledigt sind, öffnet sich der Extraction-Schacht in der Aula.",
    ],
  },
  {
    title: "Extraction",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Linksklick mit Stuhl in der Hand - Stuhl werfen.",
