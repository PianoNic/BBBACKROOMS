...
from app.domain.world.challenges.laptop_challenge_factory import RPG_BOSS_HP, RPG_PLAYER_HP
...
class RpgBattle:
    def play_rpg(self, lp: Laptop, player_id: str, choice: str | None) -> tuple[bool, dict]:
