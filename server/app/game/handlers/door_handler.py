...
from app.game.handlers.noise_handler import DOOR_RADIUS, NoiseHandler
...
class DoorHandler:
    ...
    async def handle_door_toggle(self, lobby: Lobby, me: PlayerConn, door_id: str) -> None:
        ...
        self._noise_handler.emit_noise(lobby, d.x, d.z, DOOR_RADIUS)
        await self._broadcaster.broadcast(lobby, {
            "type": "door_state", "id": d.id, "isOpen": d.is_open, "by": me.id,
        })

    async def maybe_teacher_toggle(self, lobby: Lobby, rng: random.Random) -> None:
